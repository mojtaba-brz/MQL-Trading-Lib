...
//|                                                                  |
//+------------------------------------------------------------------+
void draw_major_and_minor_round_number_level_line_if_is_new(string prefix, int major_level_pips, int minor_level_pips)
{
    int num_of_major_levels_on_one_side = 3;
