...
#define SYDNEY_SESSION_START_HOUR_FOREX (1)
#define SYDNEY_SESSION_END_HOUR_FOREX (10)
#define JAPAN_SESSION_START_HOUR_FOREX (4)
#define JAPAN_SESSION_END_HOUR_FOREX (13)
#define LONDON_SESSION_START_HOUR_FOREX (11)
#define LONDON_SESSION_END_HOUR_FOREX (20)
#define NY_SESSION_START_HOUR_FOREX (16)
#define NY_SESSION_END_HOUR_FOREX (1)
